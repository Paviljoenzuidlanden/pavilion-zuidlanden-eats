...
const menuItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Familiezak rustieke friet met schil (2 pers.)", price: "6,25" },
      { name: "Familiezak rustieke friet met schil (3 pers.)", price: "9,50" },
      { name: "Familiezak rustieke friet met schil (4 pers.)", price: "13,00" },
      { name: "Familiezak rustieke friet met schil (5 pers.)", price: "16,50" },
      { name: "Familiezak rustieke friet met schil (6 pers.)", price: "19,00" },
    ],
  },
  {
    category: "Snacks",
